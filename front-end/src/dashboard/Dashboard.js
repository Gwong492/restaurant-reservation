...
function Dashboard() {
  ...
  async function handleFinish(table_id) {
    if (
      ...
      try {
        console.log(`Table:${table_id} is now Free`);
    ...
    <main className="container-fluid p-3">
      <div className="text-center mb-4">
        ...
        <div className="btn-group">
          <button onClick={() => updateQuery(0)} className="btn submit-button">
            Previous
          </button>
          <button
          ...
          <button onClick={() => updateQuery(1)} className="btn submit-button">
            Next
          </button>
        </div>
